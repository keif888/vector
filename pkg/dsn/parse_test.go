...
func TestParse(t *testing.T) {
	tests := []struct {
		...
		{
			name: "Qdrant1",
			in:   "api-key=myapikeY usertls=false skipcompatabilitycheck=true poolsize=5 keepalivetime=30 keepalivetimeout=5 host=qdrant port=4003",
			want: DSN{
				DSN:      "api-key=myapikeY usertls=false skipcompatabilitycheck=true poolsize=5 keepalivetime=30 keepalivetimeout=5 host=qdrant port=4003",
				Driver:   DriverQdrant,
				User:     "",
				Password: "myapikeY",
				Server:   "qdrant:4003",
				Name:     "",
				Params:   "usertls=false skipcompatabilitycheck=true poolsize=5 keepalivetime=30 keepalivetimeout=5",
			},
			succeeded: true,
		},
		{
