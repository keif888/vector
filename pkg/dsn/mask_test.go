...
func TestMask(t *testing.T) {
	tests := []struct {
		...
		{name: "PostgresURL", in: "postgresql://alice:s3cr3t@postgres:5432/my_db?TimeZone=UTC&connect_timeout=15&lock_timeout=5000&sslmode=disable", out: "postgresql://alice:***@postgres:5432/my_db?TimeZone=UTC&connect_timeout=15&lock_timeout=5000&sslmode=disable"},
	}
